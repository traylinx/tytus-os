...
export const WORKSPACE_APP_VERSION = '0.3.3';
export const WORKSPACE_APP_MANIFEST_URL =
  'https://raw.githubusercontent.com/traylinx/tytus-app-atomek/v0.3.3/tytus-app.json';
export const WORKSPACE_APP_ENTRY_URL =
  'https://cdn.jsdelivr.net/gh/traylinx/tytus-app-atomek@v0.3.3/dist/index.js';
