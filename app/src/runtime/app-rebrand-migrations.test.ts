  ...
  it('does not downgrade a canonical workspace row newer than the migration floor', async () => {
    const futureCanonical: InstalledAppRow = {
      ...
      manifest: {
        ...
        version: '99.0.0',
        entry: {
          url: 'https://cdn.jsdelivr.net/gh/traylinx/tytus-app-atomek@v99.0.0/dist/index.js',
        },
      },
      entryUrl:
        'https://cdn.jsdelivr.net/gh/traylinx/tytus-app-atomek@v99.0.0/dist/index.js',
      manifestUrl:
        'https://cdn.jsdelivr.net/gh/traylinx/tytus-app-atomek@v99.0.0/tytus-app.json',
    };
    ...
    expect(rows[0].manifest.version).toBe('99.0.0');
  });
