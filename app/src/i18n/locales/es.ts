...
export const es: TranslationMap = {
  ...
  "settings.appearance.language.description": "Elige el idioma de visualización de TytusOS.",
  ...
  'top.aboutTytusOS': 'Acerca de TytusOS',
  ...
  'settings.languages.officialTitle': 'Añadir desde GitHub oficial de TytusOS',
  'settings.languages.officialHint': 'Aquí solo se pueden descargar paquetes listados en el catálogo oficial de GitHub de TytusOS. Las URL arbitrarias están bloqueadas.',
  ...
  'agents.openclaw.highlight.2':
    'Endurecido con el sandbox NVIDIA NemoClaw para mayor seguridad',
