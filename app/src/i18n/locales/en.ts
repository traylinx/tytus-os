...
export const en: TranslationMap = {
  ...
  "app.chat.description": "Your pods are teammates — open Tytus Chat, DM or @-mention them, and manage connected channels.",
  ...
  "tytusChat.hub.tagline": "Your pods are teammates. Open Tytus Chat to DM or @-mention them — replies run on your own pod.",
  "tytusChat.hub.open": "Open Tytus Chat",
  "tytusChat.hub.getDesktop": "Get the desktop app",
  "tytusChat.hub.podsTitle": "Your pods",
  "tytusChat.hub.podSubtitle": "{runtime} · pod {podId}",
  "tytusChat.hub.podsEmpty": "No pods yet. Allocate one in Pod Inspector to get a teammate in Tytus Chat.",
  "tytusChat.hub.podsEmptyCta": "Open Pod Inspector",
  "tytusChat.hub.channelsTitle": "Connected channels",
  "tytusChat.hub.channelsEmpty": "No channels connected yet. Reach your pods from Telegram, Slack and more.",
  "tytusChat.hub.openMessenger": "Open {name}",
  "tytusChat.hub.manageChannels": "Manage channels",
  "tytusChat.hub.podsSidebarTitle": "Your pods",
  "tytusChat.hub.openInChat": "Open in Tytus Chat",
  "tytusChat.hub.howTitle": "How Tytus Chat works",
  "tytusChat.hub.howBody": "DM a pod or @-mention it in a shared channel — replies run on that pod. Connect Telegram, Slack and more to reach your team from anywhere.",
  ...
  "files.shared.syncStatus.initialSyncing": "syncing initial files",
  "files.shared.syncStatus.syncing": "syncing",
  "files.shared.syncStatus.synced": "synced",
  "files.shared.syncStatus.pending": "waiting to sync",
  "files.shared.syncStatus.attention": "sync needs attention",
  "files.shared.syncStatus.syncedExcludesApplied": "synced (excludes applied)",
  "files.shared.syncStatus.failed": "sync failed",
  "files.shared.syncStatus.degraded": "sync degraded",
  "files.shared.syncStatus.unknown": "sync status unknown",
  "files.shared.syncNow": "Sync now",
  "files.shared.retrySync": "Retry sync",
  "files.shared.syncAlreadyRunningTitle": "Sync is already running for this folder",
  ...
  "files.shared.status.verified": "verified",
  "files.shared.status.selected": "selected",
  "files.shared.status.grantMissing": "grant missing",
  "files.shared.status.needsReprovision": "needs reprovision",
  ...
  "update.available.body": "Tytus OS {version} is ready to install.",
  "update.available.current": "You're currently on {current}.",
  "update.available.manualHint": "Run this command in your terminal to update:",
  "update.available.install": "Update now",
  "update.available.installing": "Installing…",
  "update.available.later": "Later",
  "update.available.close": "Close",
  "update.available.error": "Couldn't start the update:",
