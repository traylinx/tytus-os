...
export const en: TranslationMap = {
  ...
  "shell.Music Creator Settings…": "Music Creator Settings…",
  ...
  "app.musiccreator.name": "Music Creator",
  ...
  'musiccreator.empty.body':
    "Music Creator routes through your Tytus pod's AI gateway. Allocate a pod from Pod Inspector to start composing.",
